  ...
  <article <?php post_class( 'pb-28 container-base bg-white min-h-full' ); ?>>
    ...
    <?php if ( has_post_thumbnail() ) : ?>
      <div class="h-[200px] lg:h-[360px] md:h-96 relative">
        ...
        <div class="absolute left-1/2 -translate-x-1/2 top-1/2 -translate-y-1/2 h-full w-screen lg:w-[calc(100%+calc(247px*2))] overflow-hidden bg-gray3">
          <?php the_post_thumbnail(array('1834', '360'), array('class' => 'w-full h-full object-cover object-top')); ?>
        </div>
