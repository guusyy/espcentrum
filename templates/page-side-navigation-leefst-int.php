              ...
              <div class="grid grid-cols-12 lg:gap-x-10">
                <div class="lg:rows-start-1 col-span-full lg:col-start-1 lg:col-span-6">
                  <div class="h-full py-6 lg:py-10 xl:py-14">
                    <div class="flex items-center gap-5 mb-4 lg:mb-8">
                      <svg class="!w-[24px] !h-[22px] lg:!w-[50px] lg:!h-[47px]" width="50" height="47" viewBox="0 0 50 47" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <div class="relative row-start-1 col-span-full lg:col-start-7 lg:col-span-6">
                  <div class="h-[250px] lg:h-[374px]">
                    <div class="absolute bottom-0 left-0 z-50 hidden min-h-full lg:block">
                      <svg class="fill-[#ECFFF1] z-50 min-h-full w-auto" width="247" height="374" viewBox="0 0 247 374" xmlns="http://www.w3.org/2000/svg">
