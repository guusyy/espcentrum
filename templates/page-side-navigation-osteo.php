<?php
/*
Template Name: Osteopathie hoofdpagina
	...
	<?php if ( have_posts() ) : ?>
      ...
      <main class="flex-grow bg-white">
        <?php if ( has_post_thumbnail() ) : ?>
          <div class="bg-[#ECF1FF] overflow-hidden">
            <div class="relative w-full mx-auto container-base">
                ...
                <div class="lg:rows-start-1 col-span-full lg:col-start-1 lg:col-span-6">
                  <div class="h-full py-6 lg:py-10 xl:py-14">
                    ...
                    <svg class="!w-[28px] !h-[36px] lg:!w-[53px] lg:!h-[46px]" width="53" height="47" viewBox="0 0 53 47" fill="none" xmlns="http://www.w3.org/2000/svg">
                      ...
                      <h1 class="text-4xl font-bold leading-[1.1] text-themeblue"><?php echo get_field('titel'); ?></h1>
                    </div>
                ...
                <div class="relative row-start-1 col-span-full lg:col-start-7 lg:col-span-6">
                  <div class="h-[250px] lg:h-[374px]">
                    <div class="absolute bottom-0 left-0 z-50 hidden h-full lg:block">
                      <svg class="fill-[#ECF1FF] z-50 h-full" width="247" height="374" viewBox="0 0 247 374" xmlns="http://www.w3.org/2000/svg"  preserveAspectRatio="none">
              ...
              <div class="absolute bottom-0 z-50 hidden h-full lg:block left-full">
                <svg class="fill-[#ECF1FF] z-50 rotate-180 h-full" width="247" height="374" viewBox="0 0 247 374" xmlns="http://www.w3.org/2000/svg"  preserveAspectRatio="none">
                  <path d="M246.534 0.000224087L0.000366211 374V0.000213623L246.534 0.000224087Z" fill="#ECF1FF"/>
                </svg>
              </div>
            </div>
