        ...
        <div class="relative w-full mx-auto container-base">
            ...
            <div class="relative row-start-1 col-span-full lg:col-start-7 lg:col-span-6">
                <div class="h-[200px] lg:h-[374px]">
                    ...
                    <div class="absolute left-1/2 -translate-x-1/2 lg:left-0 lg:translate-x-0 top-1/2 -translate-y-1/2 h-full w-screen lg:w-[calc(100%+260px)] overflow-hidden bg-themepurple/20">
                        <?php if ( isset( $attributes['afbeelding']['url'] ) ) : ?>
                            <?php echo wp_get_attachment_image( $attributes['afbeelding']['id'], array('910', '580'), "", array( "class" => "object-cover object-center w-full h-full group-hover:scale-[1.04] !duration-500 !transition-all" ) ); ?>
                        <?php endif; ?>
                    </div>
                </div>
            </div>
