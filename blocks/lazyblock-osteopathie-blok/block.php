        ...
        <div class="relative w-full mx-auto container-base">
            ...
            <div class="relative row-start-1 col-span-full lg:col-start-7 lg:col-span-6">
                <div class="h-[200px] lg:h-[374px]">
                    ...
                    <div class="absolute left-1/2 -translate-x-1/2 lg:left-0 lg:translate-x-0 top-1/2 -translate-y-1/2 h-full w-screen lg:w-[calc(100%+260px)] overflow-hidden bg-themeblue/20">
